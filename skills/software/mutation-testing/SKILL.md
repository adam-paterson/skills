...
description: Use when assessing or improving test suite strength with mutation testing: select the right tool, establish a baseline, interpret surviving mutants, add behavior-focused tests, and report mutation score evidence.
---
...
9. When using a spec package, update `TEST-PLAN.md` with mutation targets and append baseline/final mutation evidence to `EVIDENCE.md`.
