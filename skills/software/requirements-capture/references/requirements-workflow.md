...
`requirements-capture` owns `REQUIREMENTS.md` after external `grill-with-docs` has completed or been explicitly skipped. It may append local decisions to `DECISIONS.md`.
...
- Project-language review complete or skipped: yes/no
