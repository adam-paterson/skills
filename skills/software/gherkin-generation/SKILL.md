...
description: Use when writing or refining Gherkin feature files from requirements or examples: produce precise Feature, Rule, Background, Scenario, Scenario Outline, tags, and step wording that can drive BDD automation.
---
...
1. Check whether the user named a spec package under `docs/specs/<spec-id>/`. If present, read `REQUIREMENTS.md`, `ACCEPTANCE.md`, `SPEC.md`, and `docs/agents/spec-workflow.md`.
...
8. When using a spec package, write or update `scenarios/acceptance.feature` and reflect the scenario coverage in `ACCEPTANCE.md` or `TEST-PLAN.md` if needed.
