...
description: Use when adding or improving property-based tests: identify invariants, generators, shrinking behavior, seeds, edge cases, and replayable randomized checks with tools such as fast-check, Hypothesis, jqwik, ScalaCheck, or proptest.
---
...
9. When using a spec package, update `TEST-PLAN.md` with property candidates and append observed property-test results to `EVIDENCE.md`.
