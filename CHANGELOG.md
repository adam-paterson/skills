...
- Software workflow skills that compose into an enterprise spec-package flow: `delivery-workflow`, `requirements-intake`, `requirements-capture`, `spec-generation`, `acceptance-design`, `to-gherkin`, `implement-spec`, `verify-spec`, `release-readiness`, `property-testing`, and `mutation-testing`.
